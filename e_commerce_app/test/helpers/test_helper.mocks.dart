...
import 'package:e_commerce_app/core/errors/failures.dart' as _i5;
import 'package:e_commerce_app/domain/entities/product.dart' as _i6;
...
class MockProductRepository extends _i1.Mock implements _i3.ProductRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.Product>> getProduct(int? productid) =>
      (super.noSuchMethod(
        Invocation.method(
          #getProduct,
          [productid],
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, void>> deleteProduct(int? productid) =>
      (super.noSuchMethod(
        Invocation.method(
          #deleteProduct,
          [productid],
